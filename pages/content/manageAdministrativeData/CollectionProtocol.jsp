            ...
            <table width="100%" border="0" cellpadding="3" cellspacing="0"
                ...
                <tr>
                    ...
                    <td align="left"><html:text styleClass="black_ar"
                        ...
                        property="descriptionURL" readonly='${requestScope.readOnlyValue}' />
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td width="16%" align="left" class="black_ar"><label
                        ...
                        key="collectionProtocol.isEMPIEnable" /> </label></td>
                    <td align="left" class="black_ar"><html:radio
                ...
                <tr>
                    ...
                    <td align="left" class="black_ar"><html:radio
                        property="aliqoutInSameContainer" styleId="aliqoutInSameContainer"
                        value="true" />&nbsp;<bean:message key="consent.consentwaivedyes" />&nbsp;&nbsp;<html:radio
                        property="aliqoutInSameContainer" styleId="aliqoutInSameContainer"
                        value="false" />&nbsp;<label for="consentWaived"><bean:message
                        key="consent.consentwaivedno" /></label></td>
